...
const page = () => {
  ...
  return (
    <div>
      ...
      {/* Hero Section */}
      <section className="relative text-white py-20 px-4 overflow-hidden mt-34 md:mt-36 h-[50vh]">
        {/* Background Image */}
            ...
            {solutions.map((solution, index) => (
              ...
              >
                <div className="p-8">
                  ...
                  <Link
                    href={solution.path}
                    className="inline-flex items-center text-blue-600 font-semibold hover:text-blue-800 transition-colors duration-300 group-hover:translate-x-1 transform"
                  >
                    Learn More
                    <svg
